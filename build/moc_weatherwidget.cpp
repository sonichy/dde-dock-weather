...
QT_MOC_LITERAL(1, 14, 21), // "requestUpdateGeometry"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 18) // "requestContextMenu"

    },
    "WeatherWidget\0requestUpdateGeometry\0"
    "\0requestContextMenu"
};
...
void WeatherWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->requestContextMenu(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (WeatherWidget::*_t)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WeatherWidget::requestUpdateGeometry)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (WeatherWidget::*_t)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WeatherWidget::requestContextMenu)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WeatherWidget::requestUpdateGeometry()const
{
    QMetaObject::activate(const_cast< WeatherWidget *>(this), &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void WeatherWidget::requestContextMenu()const
{
    QMetaObject::activate(const_cast< WeatherWidget *>(this), &staticMetaObject, 1, nullptr);
}
QT_WARNING_POP
