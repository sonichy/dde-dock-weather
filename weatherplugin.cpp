...
void WeatherPlugin::set()
{
    ...
    label = new QLabel("Buscar ciudad y pais en openweathermap.org");
    hbox->addWidget(label);
    vbox->addLayout(hbox);
    QPushButton *pushButton_confirm = new QPushButton("Confirmar");
    QPushButton *pushButton_cancel = new QPushButton("Cancelar");
